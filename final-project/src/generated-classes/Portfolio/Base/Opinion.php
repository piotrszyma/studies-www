 ...
 */
abstract class Opinion implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Portfolio\\Map\\OpinionTableMap';
    ...
    /**
     * Initializes internal state of Portfolio\Base\Opinion object.
     */
    ...
    /**
     * Compares this with another <code>Opinion</code> instance.  If
     * <code>obj</code> is an instance of <code>Opinion</code>, delegates to
     * <code>equals(Opinion)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Opinion The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[OpinionTableMap::COL_ID] = true;
        }
    ...
    public function setAuthor($v)
    {
        ...
        if ($this->author !== $v) {
            $this->author = $v;
            $this->modifiedColumns[OpinionTableMap::COL_AUTHOR] = true;
        }
    ...
    public function setComment($v)
    {
        ...
        if ($this->comment !== $v) {
            $this->comment = $v;
            $this->modifiedColumns[OpinionTableMap::COL_COMMENT] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildOpinionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Opinion::setDeleted()
     * @see Opinion::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildOpinionQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OpinionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('opinion_id_seq')");
        ...
        $sql = sprintf(
            'INSERT INTO opinion (%s) VALUES (%s)',
    ...
    {
        $pos = OpinionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['Opinion'][$this->hashCode()] = true;
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Portfolio\Opinion The current object, for fluid interface
     */
    ...
    {
        $criteria = ChildOpinionQuery::create();
        $criteria->add(OpinionTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Portfolio\Opinion (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Portfolio\Opinion Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(OpinionTableMap::DEFAULT_STRING_FORMAT);
    }
