...
abstract class Semester implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Portfolio\\Map\\SemesterTableMap';
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Portfolio\Semester
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Portfolio\Semester The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Portfolio\Semester (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Portfolio\Semester Clone of current object.
     * @throws PropelException
     */
