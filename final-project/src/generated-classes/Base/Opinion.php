...
use \OpinionQuery as ChildOpinionQuery;
use \Exception;
use \PDO;
use Map\OpinionTableMap;
...
abstract class Opinion implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\OpinionTableMap';
    ...
    /**
     * Initializes internal state of Base\Opinion object.
     */
     ...
     * @return $this|\Opinion The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Opinion'), 0, $e);
        }
    }
