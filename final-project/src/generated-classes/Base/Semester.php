...
use \semesterListing as ChildsemesterListing;
...
/**
 * Base class that represents a row from the 'semester' table.
 *
 *
 *
...
abstract class Semester implements ActiveRecordInterface
{
     ...
     *
     * @return $this|Semester The current object, for fluid interface
     */
     ...
     * @return $this|\Semester The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[SemesterTableMap::COL_ID] = true;
        }
    ...
    public function setAbout($v)
    {
        ...
        if ($this->about !== $v) {
            $this->about = $v;
            $this->modifiedColumns[SemesterTableMap::COL_ABOUT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Semester'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('semester_id_seq')");
        ...
        $sql = sprintf(
            'INSERT INTO semester (%s) VALUES (%s)',
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Semester'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Semester'][$this->hashCode()] = true;
    ...
    {
        $criteria = ChildSemesterQuery::create();
        $criteria->add(SemesterTableMap::COL_ID, $this->id);
    ...
    public function initsemesterListings($overrideExisting = true)
    {
        ...
        $this->collsemesterListings->setModel('\semesterListing');
    }
