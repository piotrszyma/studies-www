 ...
 *
 * @method     \HobbyListingQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class HobbyQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\HobbyQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'portfolio', $modelName = '\\Hobby', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \HobbyListing object
     *
     * @param \HobbyListing|ObjectCollection $hobbyListing the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    {
        if ($hobbyListing instanceof \HobbyListing) {
            return $this
            ...
            throw new PropelException('filterByHobbyListing() only accepts arguments of type \HobbyListing or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \HobbyListingQuery A secondary query class using the current class as primary query
     */
    public function useHobbyListingQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'HobbyListing', '\HobbyListingQuery');
    }
