 ...
 *
 * @method     \semesterListingQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class SemesterQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'portfolio', $modelName = '\\Semester', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \semesterListing object
     *
     * @param \semesterListing|ObjectCollection $semesterListing the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    {
        if ($semesterListing instanceof \semesterListing) {
            return $this
            ...
            throw new PropelException('filterBysemesterListing() only accepts arguments of type \semesterListing or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \semesterListingQuery A secondary query class using the current class as primary query
     */
    public function usesemesterListingQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'semesterListing', '\semesterListingQuery');
    }
