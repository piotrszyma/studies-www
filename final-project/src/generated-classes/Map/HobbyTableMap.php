...
class HobbyTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.HobbyTableMap';
     ...
     */
    const OM_CLASS = '\\Hobby';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Hobby';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'Description', ),
        self::TYPE_CAMELNAME     => array('id', 'title', 'description', ),
        self::TYPE_COLNAME       => array(HobbyTableMap::COL_ID, HobbyTableMap::COL_TITLE, HobbyTableMap::COL_DESCRIPTION, ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'description', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'Description' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'title' => 1, 'description' => 2, ),
        self::TYPE_COLNAME       => array(HobbyTableMap::COL_ID => 0, HobbyTableMap::COL_TITLE => 1, HobbyTableMap::COL_DESCRIPTION => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'description' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    {
        $this->addRelation('HobbyListing', '\\HobbyListing', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':hobby_id',
    1 => ':id',
  ),
), null, null, 'HobbyListings', false);
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Hobby) { // it's a model object
