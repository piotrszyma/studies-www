...
class HobbyListingTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.HobbyListingTableMap';
     ...
     */
    const OM_CLASS = '\\HobbyListing';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'HobbyListing';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\HobbyListing');
        $this->setPackage('');
    ...
    {
        $this->addRelation('Hobby', '\\Hobby', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':hobby_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \HobbyListing) { // it's a model object
